    ...
    <main class="conta text-center">
        ...
        <section class="row justify-content-center">
            <div class="col col-md-4 col-lg-2 mb-3" style="display: flex; flex-direction: column; align-items: center; text-align: center;">
                <img class="img-fluid img-circular" src="you.jpg" alt="Omelette">
                <div class="image-caption">
                    <strong style="margin-top: auto;">Especial Yousoro de Omelette con Arroz frito</strong>
                </div>
                <a href="Menú.pdf" class="btn btn-custom btn-sm download-button">Descargar Menú</a>
            </div>
            
            <div class="col col-md-4 col-lg-2 mb-3" style="display: flex; flex-direction: column; align-items: center; text-align: center;">
                <img class="img-fluid img-circular" src="riko.jpg" alt="Sandw Sakura">
                <div class="image-caption">
                    <strong style="margin-top: auto;">Sandwich de Sakura</strong>
                </div>
            </div>
            
            <div class="col col-md-4 col-lg-2 mb-3" style="display: flex; flex-direction: column; align-items: center; text-align: center;">
                <img class="img-fluid img-circular" src="sun.jpg" alt="Pollo Frito">
                <div class="image-caption">
                    <strong style="margin-top: auto;">Love Live Lightstick! (Pollo Frito con Salsa de Curry)</strong>
                </div>
            </div>
            <div class="col col-md-4 col-lg-2 mb-3" style="display: flex; flex-direction: column; align-items: center; text-align: center;">
                <img class="img-fluid img-circular" src="kanan.jpg" alt="Especial">
                <div class="image-caption">
                    <strong style="margin-top: auto;">The Matsuura Family’s Dinner</strong>
                </div>
            </div>
            
            <div class="col col-md-4 col-lg-2 mb-3" style="display: flex; flex-direction: column; align-items: center; text-align: center;">
                <img class="img-fluid img-circular" src="ruby.jpg" alt="Papas Fritas">
                <div class="image-caption">
                    <strong style="margin-top: auto;">Especial rojo escarlata de Papas Cajún</strong>
                </div>
            </div>
        </section> 
        <section class="info">
            ...
            <div class="row">
                <div class="row align-items-start"></div>
                    <div class=" col-md-6 colorcrem ">
                        <p><strong>Dirección:</strong> Calle del Aroma, Local 567</p>
                        <p><strong>Ubicación:</strong> Panamá</p>
                        <p><strong>Teléfono:</strong> 6009-7778</p>
                    </div>
                    <div class="col-md-6 colorcrem">
                        <p><strong>Email:</strong> info@sunshinecaf.com</p>
                        <p><strong>Horario:</strong> Lunes a Viernes: 9:00 AM - 7:00 PM<br>
